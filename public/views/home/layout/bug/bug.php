                ...
                <div class="card" style="font-family: Roboto;font-weight: 300;margin-bottom: 0px;">
                    <div class="card-content">
                        <?php
                            ...
                            echo form_open_multipart('bug?source=send&report&utf8=✓', $attributes)
                        ?>
                        ...
                        <div class="form-group">
                            <label style="font-family: Roboto;font-weight: 400;">Isi Report Bug</label>
                            <textarea class="form-control" rows="6" name="isi" style="border-radius: 0px" placeholder="Masukkan Report Bug"><?php echo set_value('isi') ?></textarea>
