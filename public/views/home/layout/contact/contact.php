        ...
        <div class="col-md-7">
            ...
            <div class="card" style="font-family: Roboto;font-weight: 300;margin-bottom: 0px;">
                <div class="card-content">
                    ...
                    echo form_open_multipart('contact?source=send&utf8=✓', $attributes)
                    ?>
                    ...
                    <div class="form-group">
                        <label style="font-family: Roboto;font-weight: 400;">Subject Email</label>
                        <input type="text" class="form-control" value="<?php echo set_value('subject') ?>" name="subject" placeholder="Subject Email" style="border-radius: 0px;">
                    ...
                    <div class="form-group">
                        <label style="font-family: Roboto;font-weight: 400;">Isi Email</label>
                        <textarea class="form-control" rows="6" name="message" style="border-radius: 0px" placeholder="Masukkan Pesan Anda"><?php echo set_value('message') ?></textarea>
