...
<head>
    ...
    <title><?php echo $title ?> &rsaquo; Nyimak.ID - Kumpulan Video Lucu Indonesia</title>
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0' name='viewport' />
    <meta name="viewport" content="width=device-width" />
    <link href="<?php echo base_url('resources/admin/css/bootstrap.min.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('resources/admin/css/animate.min.css') ?>" rel="stylesheet"/>
