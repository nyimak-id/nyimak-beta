                ...
                <div class="content">
                    <div class="edit-video">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="meta_keywords" value="<?php echo $data_videos['meta_keywords'] ?>" placeholder="Meta Keywords">
                        </div>
                        <div class="form-group">
                            <label>Descriptions Video</label>
                            <textarea class="form-control" rows="6" name="meta_descriptions" placeholder="Meta Descriptions"><?php echo $data_videos['meta_descriptions'] ?></textarea>
                        </div>
