        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="content">
                    ...
                    <hr>
                    <a href="<?php echo base_url('auth/bug?source=reload&utf8=✓') ?>" class="btn btn-danger btn-reset btn-fill" id="load" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> reloading...."><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
            </div>
        </div>
    </div>
