<div class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
                <div class="header">
                    <h4 class="title"><i class="pe-7s-shield"></i> Report Bug</h4>
                </div>
                <div class="content">
                    <div class="search">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="color: #000;"><i class="fa fa-user-circle"></i> NAMA BUG</th>
                            <th class="text-center" style="color: #000;"><i class="fa fa-envelope-o"></i> EMAIL BUG</th>
