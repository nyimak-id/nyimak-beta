if (!function (a, b) {
        ...
        function ja(a, b, c, d, e) {
            for (var f, g, h, i, j, k, m, o = a.length, p = ca(b), q = [], r = 0; o > r; r++)if (g = a[r], g || 0 === g)if ("object" === n.type(g)) n.merge(q, g.nodeType ? [g] : g); else if (ga.test(g)) {
                ...
                if (!l.leadingWhitespace && aa.test(g) && q.push(b.createTextNode(aa.exec(g)[0])), !l.tbody)for (g = "table" !== j || ha.test(g) ? "<table>" !== m[1] || ha.test(g) ? 0 : i : i.firstChild, f = g && g.childNodes.length; f--;)n.nodeName(k = g.childNodes[f], "tbody") && !k.childNodes.length && g.removeChild(k);
                for (n.merge(q, i.childNodes), i.textContent = ""; i.firstChild;)i.removeChild(i.firstChild);
                i = p.lastChild
            } else q.push(b.createTextNode(g));
            for (i && p.removeChild(i), l.appendChecked || n.grep(ea(q, "input"), ia), r = 0; g = q[r++];)if (d && n.inArray(g, d) > -1) e && e.push(g); else if (h = n.contains(g.ownerDocument, g), i = ea(p.appendChild(g), "script"), h && fa(i), c)for (f = 0; g = i[f++];)_.test(g.type || "") && c.push(g);
            return i = null, p
        }
        ...
        function bb(a) {
            if (a in ab)return a;
            for (var b = a.charAt(0).toUpperCase() + a.slice(1), c = _a.length; c--;)if (a = _a[c] + b, a in ab)return a
        }
            ...
            function va(a) {
                for (var b, c, e, f = a.length, g = d.relative[a[0].type], h = g || d.relative[" "], i = g ? 1 : 0, k = qa(function (a) {
                    ...
                    if (c = d.filter[a[i].type].apply(null, a[i].matches), c[u]) {
                        ...
                        return ua(i > 1 && ra(m), i > 1 && pa(a.slice(0, i - 1).concat({value: " " === a[i - 2].type ? "*" : ""})).replace(Q, "$1"), c, e > i && va(a.slice(i, e)), f > e && va(a = a.slice(e)), f > e && pa(a))
                    }
                    m.push(c)
                }
                return ra(m)
                            ...
                            if (q) {
                                ...
                                if (o = [g ? q.firstChild : q.lastChild], g && s) {
                                    for (m = q, l = m[u] || (m[u] = {}), k = l[m.uniqueID] || (l[m.uniqueID] = {}), j = k[a] || [], n = j[0] === w && j[1], t = n && j[2], m = n && q.childNodes[n]; m = ++n && m && m[p] || (t = n = 0) || o.pop();)if (1 === m.nodeType && ++t && m === b) {
                                        ...
                                        j = k[a] || [], n = j[0] === w && j[1], t = n), t === !1)for (; (m = ++n && m && m[p] || (t = n = 0) || o.pop()) && ((h ? m.nodeName.toLowerCase() !== r : 1 !== m.nodeType) || !++t || (s && (l = m[u] || (m[u] = {}), k = l[m.uniqueID] || (l[m.uniqueID] = {}), k[a] = [w, t]), m !== b)););
        ...
        n.event = {
            ...
            remove: function (a, b, c, d, e) {
                ...
                if (r && (k = r.events)) {
                    for (b = (b || "").match(G) || [""], j = b.length; j--;)if (h = oa.exec(b[j]) || [], o = q = h[1], p = (h[2] || "").split(".").sort(), o) {
            ...
            trigger: function (b, c, e, f) {
                ...
                if (i = m = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !na.test(q + n.event.triggered) && (q.indexOf(".") > -1 && (r = q.split("."), q = r.shift(), r.sort()), h = q.indexOf(":") < 0 && "on" + q, b = b[n.expando] ? b : new n.Event(q, "object" == typeof b && b), b.isTrigger = f ? 2 : 3, b.namespace = r.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : n.makeArray(c, [b]), l = n.event.special[q] || {}, f || !l.trigger || l.trigger.apply(e, c) !== !1)) {
                    ...
                    for (o = 0; (i = p[o++]) && !b.isPropagationStopped();)b.type = o > 1 ? j : l.bindType || q, g = (n._data(i, "events") || {})[b.type] && n._data(i, "handle"), g && g.apply(i, c), g = h && i[h], g && g.apply && M(i) && (b.result = g.apply(i, c), b.result === !1 && b.preventDefault());
        ...
        var Ja, Ka = {HTML: "block", BODY: "block"}, Na = /^margin/, Oa = new RegExp("^(" + T + ")(?!px)[a-z%]+$", "i"),
            Pa = function (a, b, c, d) {
                var e, f, g = {};
            ...
            valHooks: {
                option: {
                    ...
                    get: function (a) {
                        ...
                        for (var c, d, e = a.options, f = n.makeArray(b), g = e.length; g--;)if (d = e[g], n.inArray(n.valHooks.option.get(d), f) > -1)try {
                            d.selected = c = !0
                        } catch (a) {
                            d.scrollHeight
                        } else d.selected = !1;
        ...
        n.fn.extend({
            ...
            attr: function (a, b, c) {
                ...
                if (f && 1 === a.nodeType)for (; c = f[e++];)d = n.propFix[c] || c, n.expr.match.bool.test(c) ? yb && xb || !wb.test(c) ? a[d] = !1 : a[n.camelCase("default-" + c)] = a[d] = !1 : n.attr(a, c, ""), a.removeAttribute(xb ? c : d)
            }
        }), ub = {
            set: function (a, b, c) {
        ...
        n.fn.extend({
            addClass: function (a) {
                ...
                if ("string" == typeof a && a)for (b = a.match(G) || []; c = this[i++];)if (e = Cb(c), d = 1 === c.nodeType && (" " + e + " ").replace(Bb, " ")) {
                ...
                return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : n.isFunction(a) ? this.each(function (c) {
                    ...
                    var b, d, e, f;
                    if ("string" === c)for (d = 0, e = n(this), f = a.match(G) || []; b = f[d++];)e.hasClass(b) ? e.removeClass(b) : e.addClass(b); else void 0 !== a && "boolean" !== c || (b = Cb(this), b && n._data(this, "__className__", b), n.attr(this, "class", b || a === !1 ? "" : n._data(this, "__className__") || ""))
                })
            }, hasClass: function (a) {
                var b, c, d = 0;
                for (b = " " + a + " "; c = this[d++];)if (1 === c.nodeType && (" " + Cb(c) + " ").replace(Bb, " ").indexOf(b) > -1)return !0;
                return !1
            }
...
+function (a) {
    ...
    function e(a, c, e) {
        var f;
        return f = "translate3d" === b.positionUsing ? {transform: "translate3d(" + d(a) + "%,0,0)"} : "translate" === b.positionUsing ? {transform: "translate(" + d(a) + "%,0)"} : {"margin-left": d(a) + "%"}, f.transition = "all " + c + "ms " + e, f
    }
    ...
    a.configure = function (a) {
        ...
        var h = a.isStarted();
        d = c(d, b.minimum, 1), a.status = 1 === d ? null : d;
        var i = a.render(!h), j = i.querySelector(b.barSelector), k = b.speed, l = b.easing;
        return i.offsetWidth, f(function (c) {
            "" === b.positionUsing && (b.positionUsing = a.getPositioningCSS()), g(j, e(d, k, l)), 1 === d ? (g(i, {
                transition: "none",
                opacity: 1
            }), i.offsetWidth, setTimeout(function () {
                g(i, {transition: "all " + k + "ms linear", opacity: 0}), setTimeout(function () {
                    a.remove(), c()
                }, k)
            }, k)) : setTimeout(c, k)
        }), this
        ...
        var d = a.status;
        return d ? d > 1 ? void 0 : ("number" != typeof b && (b = d >= 0 && d < .25 ? (3 * Math.random() + 3) / 100 : d >= .25 && d < .65 ? 3 * Math.random() / 100 : d >= .65 && d < .9 ? 2 * Math.random() / 100 : d >= .9 && d < .99 ? .005 : 0), d = c(d + b, 0, .994), a.set(d)) : a.start()
    }, a.trickle = function () {
        return a.inc()
    }, function () {
        var b = 0, c = 0;
        ...
        e.id = "nprogress", e.innerHTML = b.template;
        var k, f = e.querySelector(b.barSelector), h = c ? "-100" : d(a.status || 0),
    ...
    var f = function () {
        ...
        function d(b) {
            ...
            if (b in c)return b;
            for (var f, d = a.length, e = b.charAt(0).toUpperCase() + b.slice(1); d--;)if (f = a[d] + e, f in c)return f;
            return b
        }
        ...
        return function (a, b) {
            var d, e, c = arguments;
            if (2 == c.length)for (d in b)e = b[d], void 0 !== e && b.hasOwnProperty(d) && f(a, d, e); else f(a, c[1], c[2])
        }
    }();
    return a
}), function (a) {
    var b = function () {
        ...
        return b.mixin(c.prototype, {
            set: function (b, c) {
                ...
                this.size >= this.maxSize && (this.list.remove(d), delete this.hash[d.key]), (f = this.hash[b]) ? (f.val = c, this.list.moveToFront(f)) : (f = new e(b, c), this.list.add(f), this.hash[b] = f, this.size++)
            }, get: function (b) {
                var c = this.hash[b];
        ...
        return c = a && window.JSON ? {
            _prefix: function (a) {
                return this.prefix + a
            }, _ttlKey: function (a) {
                return this._prefix(a) + this.ttlKey
            }, get: function (b) {
                return this.isExpired(b) && this.remove(b), g(a.getItem(this._prefix(b)))
            }, set: function (c, d, g) {
                return b.isNumber(g) ? a.setItem(this._ttlKey(c), f(e() + g)) : a.removeItem(this._ttlKey(c)), a.setItem(this._prefix(c), f(d))
            }, remove: function (b) {
                ...
                var d = g(a.getItem(this._ttlKey(c)));
                return !!(b.isNumber(d) && e() > d)
            }
        } : {get: b.noop, set: b.noop, remove: b.noop, clear: b.noop, isExpired: b.noop}, b.mixin(d.prototype, c), d
    }(), g = function () {
        "use strict";
        function h(b) {
            b = b || {}, this.cancelled = !1, this.lastUrl = null, this._send = b.transport ? i(b.transport) : a.ajax, this._get = b.rateLimiter ? b.rateLimiter(this._get) : this._get, this._cache = b.cache === !1 ? new e(0) : g
        }
        ...
        return h.setMaxPendingRequests = function (b) {
            ...
            _get: function (a, b, e) {
                ...
                function k() {
                    c--, delete d[a], g.onDeckRequestArgs && (g._get.apply(g, g.onDeckRequestArgs), g.onDeckRequestArgs = null)
                }

                var h, g = this;
                this.cancelled || a !== this.lastUrl || ((h = d[a]) ? h.done(i).fail(j) : c < f ? (c++, d[a] = this._send(a, b).done(i).fail(j).always(k)) : this.onDeckRequestArgs = [].slice.call(arguments, 0))
            }, get: function (a, c, d) {
                var e;
        ...
        return b.mixin(c.prototype, {
            bootstrap: function (b) {
                ...
                var h, i, e = this;
                return h = d(this.queryTokenizer(c)), b.each(h, function (a) {
                    var b, c, d, f;
                    if (i && 0 === i.length)return !1;
                    for (b = e.trie, c = a.split(""); b && (d = c.shift());)b = b.children[d];
                    return b && 0 === c.length ? (f = b.ids.slice(0), void(i = i ? g(i, f) : f)) : (i = [], !1)
                }), i ? b.map(f(i), function (a) {
                    return e.datums[a]
                }) : []
            }, reset: function () {
        ...
        function f(c) {
            ...
            return e = {
                ...
                filter: null,
                ajax: {}
            }, (d = c.remote || null) && (d = b.isString(d) ? {url: d} : d, d = b.mixin(e, d), d.rateLimiter = /^throttle$/i.test(d.rateLimitBy) ? g(d.rateLimitWait) : f(d.rateLimitWait), d.ajax.type = d.ajax.type || "GET", d.ajax.dataType = d.ajax.dataType || "json", delete d.rateLimitBy, delete d.rateLimitWait, !d.url && a.error("remote requires url to be set")), d
        }
    ...
    !function (c) {
        ...
        var e, j;
        return e = c.Bloodhound, j = {
            data: "data",
            protocol: "protocol",
            thumbprint: "thumbprint"
        }, c.Bloodhound = k, k.noConflict = function () {
            return c.Bloodhound = e, k
        }, k.tokenizers = d, b.mixin(k.prototype, {
            _loadPrefetch: function (c) {
                function g(a) {
                    d.clear(), d.add(c.filter ? c.filter(a) : a), d._saveToStorage(d.index.serialize(), c.thumbprint, c.ttl)
                }

                var e, f, d = this;
                return (e = this._readFromStorage(c.thumbprint)) ? (this.index.bootstrap(e), f = a.Deferred().resolve()) : f = a.ajax(c.url, c.ajax).done(g), f
            }, _getFromRemote: function (b, c) {
                function g(a, b) {
                    c(a ? [] : d.remote.filter ? d.remote.filter(b) : b)
                }

                var e, f, d = this;
                if (this.transport)return b = b || "", f = encodeURIComponent(b), e = this.remote.replace ? this.remote.replace(this.remote.url, b) : this.remote.url.replace(this.remote.wildcard, f), this.transport.get(e, this.remote.ajax, g)
            }, _cancelLastRemoteRequest: function () {
                this.transport && this.transport.cancel()
            }, _saveToStorage: function (b, c, d) {
                this.storage && (this.storage.set(j.data, b, d), this.storage.set(j.protocol, location.protocol, d), this.storage.set(j.thumbprint, c, d))
            }, _readFromStorage: function (b) {
                var d, c = {};
                return this.storage && (c.data = this.storage.get(j.data), c.protocol = this.storage.get(j.protocol), c.thumbprint = this.storage.get(j.thumbprint)), d = c.thumbprint !== b || c.protocol !== location.protocol, c.data && !d ? c.data : null
            }, _initialize: function () {
                function h() {
                    d.add(b.isFunction(e) ? e() : e)
                }

                var f, d = this, e = this.local;
                return f = this.prefetch ? this._loadPrefetch(this.prefetch) : a.Deferred().resolve(), e && f.done(h), this.transport = this.remote ? new g(this.remote) : null, this.initPromise = f.promise()
                ...
                function h(a) {
                    ...
                    b.each(a, function (a) {
                        var d;
                        return d = b.some(c, function (b) {
                            return e.dupDetector(a, b)
                        }), !d && c.push(a), c.length < e.limit
                    }), d && d(e.sorter(c))
                }

                var e = this, f = [], g = !1;
                f = this.index.get(c), f = this.sorter(f).slice(0, this.limit), f.length < this.limit ? g = this._getFromRemote(c, h) : this._cancelLastRemoteRequest(), g || (f.length > 0 || !this.transport) && d && d(f)
            }, clear: function () {
                this.index.reset()
    ...
    var j = function () {
        ...
        function d(d) {
            ...
            d = d || {}, d.input || a.error("input is missing"), g = b.bind(this._onBlur, this), h = b.bind(this._onFocus, this), i = b.bind(this._onKeydown, this), j = b.bind(this._onInput, this), this.$hint = a(d.hint), this.$input = a(d.input).on("blur.tt", g).on("focus.tt", h).on("keydown.tt", i), 0 === this.$hint.length && (this.setHint = this.getHint = this.clearHint = this.clearHintIfInvalid = b.noop), b.isMsie() ? this.$input.on("keydown.tt keypress.tt cut.tt paste.tt", function (a) {
                c[a.which || a.keyCode] || b.defer(b.bind(f._onInput, f, a))
            }) : this.$input.on("input.tt", j), this.query = this.$input.val(), this.$overflowHelper = e(this.$input)
        }
        ...
        return c = {
            ...
            _onBlur: function () {
                ...
                switch (b) {
                    case"tab":
                        e = this.getHint(), f = this.getInputValue(), d = e && e !== f && !g(c);
                        break;
                    case"up":
                    case"down":
                        d = !g(c);
                ...
                var b, c, d;
                b = this.getInputValue(), c = f(b, this.query), d = !!c && this.query.length !== b.length, this.query = b, c ? d && this.trigger("whitespaceChanged", this.query) : this.trigger("queryChanged", this.query)
            }, focus: function () {
                this.$input.focus()
            }, blur: function () {
                this.$input.blur()
                ...
                this.$input.val(b), c ? this.clearHint() : this._checkInputValue()
        ...
        return f.extractDatasetName = function (d) {
            return a(d).data(c)
        }, f.extractValue = function (c) {
            return a(c).data(d)
        }, f.extractDatum = function (c) {
            return a(c).data(e)
        }, b.mixin(f.prototype, m, {
            _render: function (g, h) {
                function m() {
                    return i.templates.empty({query: g, isEmpty: !0})
                }

                function o() {
                    function m(b) {
                        var f;
                        return f = a(j.suggestion).append(i.templates.suggestion(b)).data(c, i.name).data(d, i.displayFn(b)).data(e, b), f.children().each(function () {
                            a(this).css(k.suggestionChild)
                        }), f
                    }

                    var f, l;
                    return f = a(j.suggestions).css(k.suggestions), l = b.map(h, m), f.append.apply(f, l), i.highlight && n({
                ...
                function p() {
                    return i.templates.header({query: g, isEmpty: !l})
                }

                function q() {
                    return i.templates.footer({query: g, isEmpty: !l})
                }

                if (this.$el) {
                    var l, i = this;
                    this.$el.empty(), l = h && h.length, !l && this.templates.empty ? this.$el.html(m()).prepend(i.templates.header ? p() : null).append(i.templates.footer ? q() : null) : l && this.$el.html(o()).prepend(i.templates.header ? p() : null).append(i.templates.footer ? q() : null), this.trigger("rendered")
                }
            }, getRoot: function () {
                return this.$el
            }, update: function (b) {
                function d(a) {
                    c.canceled || b !== c.query || c._render(b, a)
                }

                var c = this;
                this.query = b, this.canceled = !1, this.source(b, d)
            }, cancel: function () {
                this.canceled = !0
            }, clear: function () {
        ...
        return b.mixin(c.prototype, m, {
            _onSuggestionClick: function (c) {
                this.trigger("suggestionClicked", a(c.currentTarget))
            }, _onSuggestionMouseEnter: function (c) {
                this._removeCursor(), this._setCursor(a(c.currentTarget), !0)
                ...
                this.isEmpty = b.every(this.datasets, c), this.isEmpty ? this._hide() : this.isOpen && this._show(), this.trigger("datasetRendered")
            }, _hide: function () {
                this.$menu.hide()
            }, _show: function () {
            ...
            }, _setCursor: function (b, c) {
                b.first().addClass("tt-cursor"), !c && this.trigger("cursorMoved")
            }, _removeCursor: function () {
                this._getCursor().removeClass("tt-cursor")
            }, _moveCursor: function (b) {
                var c, d, e, f;
                if (this.isOpen) {
                    if (d = this._getCursor(), c = this._getSuggestions(), this._removeCursor(), e = c.index(d) + b, e = (e + 1) % (c.length + 1) - 1, e === -1)return void this.trigger("cursorRemoved");
                    e < -1 && (e = c.length - 1), this._setCursor(f = c.eq(e)), this._ensureVisible(f)
                }
            }, _ensureVisible: function (b) {
                var c, d, e, f;
                c = b.position().top, d = c + b.outerHeight(!0), e = this.$menu.scrollTop(), f = this.$menu.height() + parseInt(this.$menu.css("paddingTop"), 10) + parseInt(this.$menu.css("paddingBottom"), 10), c < 0 ? this.$menu.scrollTop(e + c) : f < d && this.$menu.scrollTop(e + (d - f))
            }, close: function () {
                this.isOpen && (this.isOpen = !1, this._removeCursor(), this._hide(), this.trigger("closed"))
            }, open: function () {
                this.isOpen || (this.isOpen = !0, !this.isEmpty && this._show(), this.trigger("opened"))
            }, setLanguageDirection: function (b) {
                this.$menu.css("ltr" === b ? k.ltr : k.rtl)
            }, moveCursorUp: function () {
                this._moveCursor(-1)
            }, moveCursorDown: function () {
                this._moveCursor(1)
            }, getDatumForSuggestion: function (b) {
                var c = null;
                return b.length && (c = {
                    raw: p.extractDatum(b),
                    value: p.extractValue(b),
                    datasetName: p.extractDatasetName(b)
                }), c
                ...
                b.each(this.datasets, d)
            }, empty: function () {
                function c(a) {
                    a.clear()
                }

                b.each(this.datasets, c), this.isEmpty = !0
            }, isVisible: function () {
                ...
                this.$menu.off(".tt"), this.$menu = null, b.each(this.datasets, c)
            }
        }), c
    }(), r = function () {
        "use strict";
        function d(c) {
            var d, f, g;
            c = c || {}, c.input || a.error("missing input"), this.isActivated = !1, this.autoselect = !!c.autoselect, this.minLength = b.isNumber(c.minLength) ? c.minLength : 1, this.$node = e(c.input, c.withHint), d = this.$node.find(".tt-dropdown-menu"), f = this.$node.find(".tt-input"), g = this.$node.find(".tt-hint"), f.on("blur.tt", function (a) {
                var c, e, g;
        ...
        function e(b, d) {
            var e, g, h, i;
            e = a(b), g = a(j.wrapper).css(k.wrapper), h = a(j.dropdown).css(k.dropdown), i = e.clone().css(k.hint).css(f(e)), i.val("").removeData().addClass("tt-hint").removeAttr("id name placeholder required").prop("readonly", !0).attr({
                autocomplete: "off",
                spellcheck: "false",
                tabindex: -1
            }), e.data(c, {
                ...
                style: e.attr("style")
            }), e.addClass("tt-input").attr({autocomplete: "off", spellcheck: !1}).css(d ? k.input : k.inputWithNoHint);
            try {
        ...
        function g(a) {
            ...
            }), d.detach().removeData(c).removeClass("tt-input").insertAfter(a), a.remove()
        }

        var c = "ttAttrs";
        return b.mixin(d.prototype, {
            _onSuggestionClicked: function (b, c) {
                var d;
                (d = this.dropdown.getDatumForSuggestion(c)) && this._select(d)
            }, _onCursorMoved: function () {
                var b = this.dropdown.getDatumForCursor();
                this.input.setInputValue(b.value, !0), this.eventBus.trigger("cursorchanged", b.raw, b.datasetName)
                ...
                var d, e;
                d = this.dropdown.getDatumForCursor(), e = this.dropdown.getDatumForTopSuggestion(), d ? (this._select(d), c.preventDefault()) : this.autoselect && e && (this._select(e), c.preventDefault())
            }, _onTabKeyed: function (b, c) {
                var d;
                (d = this.dropdown.getDatumForCursor()) ? (this._select(d), c.preventDefault()) : this._autocomplete(!0)
            }, _onEscKeyed: function () {
                this.dropdown.close(), this.input.resetInputValue()
            }, _onUpKeyed: function () {
                var b = this.input.getQuery();
                this.dropdown.isEmpty && b.length >= this.minLength ? this.dropdown.update(b) : this.dropdown.moveCursorUp(), this.dropdown.open()
            }, _onDownKeyed: function () {
                var b = this.input.getQuery();
                this.dropdown.isEmpty && b.length >= this.minLength ? this.dropdown.update(b) : this.dropdown.moveCursorDown(), this.dropdown.open()
            }, _onLeftKeyed: function () {
                "rtl" === this.dir && this._autocomplete()
            }, _onRightKeyed: function () {
                "ltr" === this.dir && this._autocomplete()
            }, _onQueryChanged: function (b, c) {
                this.input.clearHintIfInvalid(), c.length >= this.minLength ? this.dropdown.update(c) : this.dropdown.empty(), this.dropdown.open(), this._setLanguageDirection()
            }, _onWhitespaceChanged: function () {
                this._updateHint(), this.dropdown.open()
            }, _setLanguageDirection: function () {
                var b;
                this.dir !== (b = this.input.getLanguageDirection()) && (this.dir = b, this.$node.css("direction", b), this.dropdown.setLanguageDirection(b))
            }, _updateHint: function () {
                var c, d, e, f, g, h;
                c = this.dropdown.getDatumForTopSuggestion(), c && this.dropdown.isVisible() && !this.input.hasOverflow() ? (d = this.input.getInputValue(), e = o.normalizeQuery(d), f = b.escapeRegExChars(e), g = new RegExp("^(?:" + f + ")(.+$)", "i"), h = g.exec(c.value), h ? this.input.setHint(d + h[1]) : this.input.clearHint()) : this.input.clearHint()
            }, _autocomplete: function (b) {
                var c, d, e, f;
                c = this.input.getHint(), d = this.input.getQuery(), e = b || this.input.isCursorAtEnd(), c && d !== c && e && (f = this.dropdown.getDatumForTopSuggestion(), f && this.input.setInputValue(f.value), this.eventBus.trigger("autocompleted", f.raw, f.datasetName))
            }, _select: function (c) {
                this.input.setQuery(c.value), this.input.setInputValue(c.value, !0), this._setLanguageDirection(), this.eventBus.trigger("selected", c.raw, c.datasetName), this.dropdown.close(), b.defer(b.bind(this.dropdown.empty, this.dropdown))
            }, open: function () {
                this.dropdown.open()
            }, close: function () {
                this.dropdown.close()
            }, setVal: function (c) {
                c = b.toStr(c), this.isActivated ? this.input.setInputValue(c) : (this.input.setQuery(c), this.input.setInputValue(c, !0)), this._setLanguageDirection()
            }, getVal: function () {
                return this.input.getQuery()
            }, destroy: function () {
                this.input.destroy(), this.dropdown.destroy(), g(this.$node), this.$node = null
            }
        }), d
    }();
    !function () {
            ...
            initialize: function (e, f) {
                function g() {
                    ...
                    b.each(f, function (a) {
                        ...
                        input: c,
                        eventBus: g = new l({el: c}),
                        withHint: !!b.isUndefined(e.hint) || !!e.hint,
                ...
                return f = b.isArray(f) ? f : [].slice.call(arguments, 1), e = e || {}, this.each(g)
            }, open: function () {
                function c() {
                    var c, b = a(this);
                    (c = b.data(d)) && c.open()
                ...
                return arguments.length ? this.each(e) : f(this.first())
            }, destroy: function () {
                function c() {
                    var c, b = a(this);
                    (c = b.data(d)) && (c.destroy(), b.removeData(d))
                }
        ...
        return function () {
            ...
            function o(b) {
                ...
                if ("undefined" != typeof b.optionsOverride && (A = a.extend(A, b.optionsOverride), B = b.optionsOverride.iconClass || B), !v(A, b)) {
                    u++, r = c(A, !0);
                    var C = null, D = a("<div/>"), E = a("<div/>"), F = a("<div/>"), G = a("<div/>"),
                        H = a(A.closeHtml), I = {intervalId: null, hideEta: null, maxHideTime: null},
                        J = {toastId: u, state: "visible", startTime: new Date, options: A, map: b};
            ...
            var r, s, t, u = 0, v = {error: "error", info: "info", success: "success", warning: "warning"}, w = {
                clear: h,
                remove: i,
                error: b,
                getContainer: c,
...
}), "console" in window && console.log("%cHi Developer\nIf you find an error please report  on this page %chttps://nyimak.id/bug/\n%cGive your feedback on this page %chttps://nyimak.id/feedback/", "color: #000000; font-size: 17px; line-height: 2", "color: #2bbbad; font-size: 17px; line-height: 2; font-style: normal", "color: #000000; font-size: 17px; line-height: 2", "color: #2bbbad; font-size: 17px; line-height: 2; font-style: normal"), $('a[href^="#"]').on("click", function (a) {
    var b = $(this.getAttribute("href"));
    b.length && (a.preventDefault(), $("html, body").stop().animate({scrollTop: b.offset().top}, 1e3))
    ...
    $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), NProgress.start(), NProgress.done()
});
var url = "http://localhost/~maulayyacyber/nyimakid/";
$(document).ready(function () {
    video_baru(0), $("#load_more").click(function (a) {
        a.preventDefault();
        var b = $(this).data("val");
        video_baru(b)
    })
});
var video_baru = function (a) {
    $("#loader").show(), $("#load_more").show(), $.ajax({
        url: url + "home/get_videos_terbaru",
        type: "GET",
        data: {page: a}
    }).done(function (a) {
        $("#videos_terbaru").append(a), $("#loader").hide(), $("#load_more").data("val", $("#load_more").data("val") + 1), "" == a && $("#load_more").hide()
    })
};
$(document).ready(function () {
    playlist(0), $("#load_more_playlist").click(function (a) {
        a.preventDefault();
        var b = $(this).data("val");
        playlist(b)
    })
...
var playlist = function (a) {
    $("#loader").show(), $("#load_more_playlist").show(), $.ajax({
        url: url + "home/get_playlist",
        type: "GET",
        data: {page: a}
    }).done(function (a) {
        $("#playlist").append(a), $("#loader").hide(), $("#load_more_playlist").data("val", $("#load_more_playlist").data("val") + 1), "" == a && $("#load_more_playlist").hide()
    })
};
$(document).ready(function () {
    video_popular(0), $("#load_more_popular").click(function (a) {
        a.preventDefault();
        var b = $(this).data("val");
        video_popular(b)
    })
});
var video_popular = function (a) {
    $("#loader").show(), $("#load_more_popular").show(), $.ajax({
        url: url + "home/get_videos_popular",
        type: "GET",
        data: {page: a}
    }).done(function (a) {
        $("#videos_popular").append(a), $("#loader").hide(), $("#load_more_popular").data("val", $("#load_more_popular").data("val") + 1), "" == a && $("#load_more_popular").hide()
    })
};
$(document).ready(function () {
    video_recomended(0), $("#load_more_recomended").click(function (a) {
        a.preventDefault();
        var b = $(this).data("val");
        video_recomended(b)
    })
});
var video_recomended = function (a) {
    $("#loader").show(), $("#load_more_recomended").show(), $.ajax({
        url: url + "home/get_videos_recomended",
        type: "GET",
        data: {page: a}
    }).done(function (a) {
        $("#videos_recomended").append(a), $("#loader").hide(), $("#load_more_recomended").data("val", $("#load_more_recomended").data("val") + 1), "" == a && $("#load_more_recomended").hide()
    })
};
$(document).ready(function () {
    developers(0), $("#load_more_developers").click(function (a) {
        a.preventDefault();
        var b = $(this).data("val");
        developers(b)
    })
});
var developers = function (a) {
    $("#loader").show(), $("#load_more_developers").show(), $.ajax({
        url: url + "pages/get_developers",
        type: "GET",
        data: {page: a}
    }).done(function (a) {
        $("#developers").append(a), $("#loader").hide(), $("#load_more_developers").data("val", $("#load_more_developers").data("val") + 1), "" == a && $("#load_more_developers").hide()
    })
};
$(document).ready(function () {
    category(0), $("#load_more_category").click(function (a) {
        a.preventDefault();
        var b = $(this).data("val");
        category(b)
    })
});
var category = function (a) {
    $("#loader").show(), $("#load_more_category").show(), $.ajax({
        url: url + "home/get_category",
        type: "GET",
        data: {page: a}
    }).done(function (a) {
        $("#category").append(a), $("#loader").hide(), $("#load_more_category").data("val", $("#load_more_category").data("val") + 1), "" == a && $("#load_more_category").hide()
    })
};
$(document).ready(function () {
    category_sidebar(0), $("#load_more_sidebar").click(function (a) {
        a.preventDefault();
        var b = $(this).data("val");
        category_sidebar(b)
    })
});
var category_sidebar = function (a) {
    $("#loader").show(), $("#load_more_sidebar").show(), $.ajax({
        url: url + "home/get_category_sidebar",
        type: "GET",
        data: {page: a}
    }).done(function (a) {
        $("#category-sidebar").append(a), $("#loader").hide(), $("#load_more_sidebar").data("val", $("#load_more_sidebar").data("val") + 1), "" == a && $("#load_more_sidebar").hide()
    })
}, scroll = function () {
    $("html, body").animate({scrollTop: $("#load_more").offset().top}, 1e3)
}, q = new Bloodhound({
    datumTokenizer: function (a) {
        return Bloodhound.tokenizers.whitespace(a.judul)
    }, queryTokenizer: Bloodhound.tokenizers.whitespace, prefetch: url + "search/json"
});
q.initialize(), q.clearPrefetchCache(), $("#q").typeahead({highlight: !0, hint: !0}, {
    displayKey: "judul",
    source: q.ttAdapter()
}), $(document).ready(function () {
    $(".search form").submit(function () {
        var a = $("[name='q']").val();
        if (0 == a.length) setTimeout(function () {
            var a = {
                debug: !1,
                positionClass: "toast-top-right",
                onclick: null,
            ...
            toastr.error("Masukkan kata kunci Anda.", a)
        }, 1e3); else {
            ...
            setTimeout(function () {
                ...
                toastr.error("Masukkan setidaknya 3 karakter kata kunci", a)
            }, 1e3)
        }
        return !1
    })
